...
public class PreprocessedReceiverBatch
{
    ...
    public int GetSelectionIndex(int instanceId) => _selectionIndices[instanceId];
    public Bit GetSelectedOption(int instanceId) => _selectedOptions[instanceId];
    public int NumberOfInstances => _selectionIndices.Length;
}
