...
namespace CompactMPC.ObliviousTransfer
{
    ...
    /// </summary>
    public class StatelessMultiChoicesObliviousObliviousTransferChannel : IMultiChoicesObliviousTransferChannel
    {
        ...
        public StatelessMultiChoicesObliviousObliviousTransferChannel(IStatelessMultiChoicesObliviousTransfer statelessOT, IMessageChannel channel)
        {
            if (statelessOT == null)
